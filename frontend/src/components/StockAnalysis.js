          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Institutional-Quality Stock Analysis Platform</p>
              </div>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-gray-100">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-gray-900 mb-3">Stock Recommendation Engine</h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Get data-driven buy, sell, or hold recommendations based on comprehensive financial analysis
            </p>
          </div>
          ...
          <form onSubmit={handleAnalysis} className="max-w-md mx-auto">
            ...
            <button
              ...
              className="w-full mt-6 px-6 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all text-lg shadow-lg"
            >
              {loading ? (
